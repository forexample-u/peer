  ...
  <div id="header" style="color: #fff;"><a href="/">Peer</a>
    ...
    <div id="menu" class="hidden">
      <ul>
        ...
        <li><button id="share">Copy link</button></li>
        <li><button onclick="window.location.href = '?links=1';">Links</button></li>
        <li><button onclick="if (confirm('Delete messages?')) { localStorage.removeItem('files'); location.reload(); }">Clear messages</button></li>
      </ul>
    </div>
  </div>
  <div id="messages"></div>
